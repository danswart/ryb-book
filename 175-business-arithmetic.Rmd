...
plot(x, probability, type = "l", col = "blue", lwd = 2, xlab = "Number of Links in the Chain",
     ylab = "Probability of Success (%)", main = "Compare the Probability of Getting The Job Done\n Right the First Time as the Number of \n Links in the Chain Increases")
...
ggplot2::ggplot(df, ggplot2::aes(x)) +
  ...
  ggplot2::theme(
    ...
    axis.title = ggplot2::element_text(size = 14, face = "bold"),  # Bigger and bold axis titles
    axis.text = ggplot2::element_text(size = 12),  # Bigger axis text
#     legend.title = ggplot2::element_blank(),  # Remove legend title
    legend.text = ggplot2::element_text(size = 12, face = "bold")  # Bigger and bold legend text
  )
