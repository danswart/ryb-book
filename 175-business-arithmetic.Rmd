...
#  To call an mp4 file using the function above.  Place it in an r chunk in an rmd file to include the mp4 in the html document


mp4_vid("vid/dms-6m-1-exceeds-1-not.mp4")

# 
mp4_vid("vid/gganimate.mp4")
# 
# 
mp4_vid("vid/ts-zoom.mp4")
